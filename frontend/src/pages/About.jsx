export function About() {
    return <>
        <div className='mb-28 mx-14'>
            <p className='font-bold text-center font-inter'>Brief History</p>
            <p className='p-2 leading-6'>
                In 1985-86, the Ministry of Welfare split into the Department of Women and Child Development and the 
